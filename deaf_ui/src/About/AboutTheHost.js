        ...
        <div className="about-host-container">
            ...
            <div className="host-description">
                ...
                <p className="description-text">
                    Molly Rathbun is a fourth-year ASL Student at the University of Virginia. She is pursuing a minor in the ASL department and is the Public Relations Chair of UVA's DEAFS club. This year she is participating in an independent study along aside her advisor Gregory Propp putting on this Deaf Lit. Festival. As a lover of literature and friend of the Deaf community, she hopes to bring together all groups of people for one large festival celebrating Deaf literature.
                </p>
            </div>
        </div>
    );
